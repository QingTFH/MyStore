...
public class RecuFunction {
     ...
     */
    private List<Expression> memo = new ArrayList<>();
    private String varName = "x";
    private Expression coe1;
    private Expression coe2;
    ...
    private void expand() {
        ...
        Expression funcN = Expression.add(f1, f2);
        memo.add(Expression.add(funcN, extra));
    }
